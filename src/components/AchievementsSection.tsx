...
const achievements = [
  {
    ...
    description:
      "Thiết lập quan hê ngoại giao với 187 quốc gia, ký kết hơn 90 Hiệp định thương mại song phương, gần 60 Hiệp định khuyến khích và bảo hộ đầu tư, và 54 Hiệp định chống đánh thuế hai lần.",
  },
  {
